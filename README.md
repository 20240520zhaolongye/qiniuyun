...
用户可以输入文本描述或简单参数，生成结构化 Prompt、透明 PNG、Sprite Sheet 和 JSON 元数据。图像生成支持 Mock Generator 和 ComfyUI API：默认使用 Mock，配置环境变量后可切换到真实 ComfyUI 工作流。
...
- 数据库：SQLite
- 核心生成：C++ CLI
- AI 生成：Mock Generator / ComfyUI API
